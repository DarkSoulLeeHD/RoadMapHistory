...
- ✅ Interaktive Roadmap (`roadmap/`): phases.json (**41 Events, 20 Kern, Dossier-Modell: goal + deep_analysis (3–4 Absätze) für alle 41, ~8.000 Wörter Analyse, 19 wörtliche Zitate, 76 Quellen mit 68 verifizierten Direktlinks — Zero Broken Links**) + debunks.json (17 Faktencheck-Einträge) + index.html (Tabs, Suche, Filter-Chips mit Live-Trefferzählern, ⭐Kern-Modus, Timeline-Spine, Dossier-Lesemodus im Modal: Goal-Banner, Historische Analyse, Evidence-Vault mit Zitat-Karten + 📋Kopie, klickbare Quellen-Karten ↗ [100 % echte Links], Print-Styles, Export, Offline-Fallback)
